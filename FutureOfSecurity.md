...
Some of these are due to the disruptions of cloud and mobility, but much of it is due to the continued advancement of our approaches to security (partially driven by our six trends, but also influenced by attackers). We covered [cloud computing in depth in our paper *What CISOs Need to Know About cloud Computing*](https://securosis.com/research/publication/what-cisos-need-to-know-about-cloud-computing). Let's look at the different skills and priorities we think the overall combination of cloud, mobile, and our six inherent security trends will emphasize.
